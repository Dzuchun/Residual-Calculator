...
public class BracerParser {
	...
	private final String[] FUNCTIONS = { "abs", "arccos", "arg", "arcsin", "arctg", "conj", "cos", "ch", "exp", "imag",
			"ln", "neg", "re", "im", "sin", "sh", "sqrt", "tg", "th" };
	...
	/* variable token */
	private final String VARIABLE = "z";
	/* settings for numbers formatting */
	private NumberFormat numberFormat = NumberFormat.getInstance();
	/* settings for complex formatting */
	private ComplexFormat complexFormat = new ComplexFormat(IMAGINARY, numberFormat);
	 ...
	 * @throws <code>ParseException</code> if the input expression is not correct
	 * @since 0.3.0
	 */
	public void parse(String expression) throws ParseException {
		...
		/*
		 * make some preparations: remove spaces; handle unary + and -, handle degree
		 * character
		 */
	...
	/**
	 * Evaluates non-variable expression and returns it's value as a Complex object
	 *
